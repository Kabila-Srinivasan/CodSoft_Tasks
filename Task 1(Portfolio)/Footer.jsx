...
const Footer = () => {
  ...
  <li><a href="/test" style={{ color: 'solid black' }}>Testimonials</a></li>
  <li><a href="#" style={{ color: 'solid black' }}>Repairs</a></li>
  <li><a href="/pay" style={{ color: 'solid black' }}>Payment Options</a></li>
  ...
  {new Date().getFullYear()} Elite Appliance Care Kabila Srinivasan.All Rights Reserved.
</h4></p>
