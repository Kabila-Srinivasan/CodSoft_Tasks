...
function FeedbackForm() {
    ...
    const feedback_type = {
        'qos': 'Please rate the quality of the service you received from our host.', 
        'qob': 'Please rate the quality of our service as how much it was useful to you.',
        'roc': 'Was our service good and satisfying? and how you felt about it',
        'exp': 'Please rate your overall service experience.'
    };
            ...
            (<Card>
                <Card.Header>
                    <cite title="Source Title">We are committed to providing you with the best
                        service experience possible, so we welcome your comments.
                    </cite>
                </Card.Header>
                <Card.Body>
                ...
                <Container className='padding30px'>
                    <Form>
                                ...
                                {Object.keys(feedback_type).map((ty) => (
                                    <Col key={ty}>
                                        <Form.Group className="mb-3" controlId={ty}>
                                            ...
                                            <InputGroup>
                                                <div className="mb-3 rating-checkbox-group">
                                                    {feedback_opts.map((opt, key) => (
                                                        <div key={key} className="form-check rating-checkbox">
                                                            <input
                        ...
                        <br/><br/><Button className='btn_purp' onClick={e=>formSubmit(e)}>Submit Review</Button>
                    </Form>
                </Container>
            </Card>
            ):(
